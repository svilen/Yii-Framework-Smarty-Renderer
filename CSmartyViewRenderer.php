...
/**
 * CSmartyViewRenderer implements a view renderer that allows users to use Smarty template syntax.
 *
...
class CSmartyViewRenderer extends CViewRenderer {
	 ...
	 * @param	string	$sourceFile		string the source view file path
	 * @param	string	$viewFile		string the resulting view file path
	 */
